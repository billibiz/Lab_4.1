<img width="685" height="754" alt="image" src="https://github.com/user-attachments/assets/e1f58dec-8f00-4aad-8d56-273838e46869" /># Лабораторная работа 4.1 Чтение данных из файла и их обработка. Запись результатов обработки в файл
## Цель работы: 
